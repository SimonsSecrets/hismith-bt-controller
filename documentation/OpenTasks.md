# HismithController open tasks

This document is a todo list for the user to remember any open tasks that still need to be completed.
It is not intended as instructions for an AI agent.

Ai agents may however mark tasks completed if they detect that they have completed them.
